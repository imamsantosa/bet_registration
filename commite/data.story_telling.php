            ...
            <div class="col-md-12">
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h3 class="panel-title">Daftar Peserta Story Telling</h3>
                </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var Table = $('#data_pendaftar').DataTable({
          "ajax": "function.php?action=data_story_telling",
          "Processing": true,
          "ServerSide": true,
          "columns": 
          [
        ...
        $('#data_pendaftar tbody').on('click', '.detail-btn', function(){
          ...
          var unme=x[2].cells;
          var tgl=x[3].cells;
          satu[0].innerHTML=datas["nama_peserta"];
          satu[1].innerHTML=datas["no_telp"];
          satu[2].innerHTML=datas["alergi"];
        ...
        $('#data_pendaftar tbody').on('click', '.hapus-btn', function(){
          ...
          if (confirm("Apakah yakin akan menghapus peserta debate dengan username "+datas["username"])) {
            $.ajax({
              type: "POST",
              url: "function.php?action=delete_story_telling",
              data: data,
